...
![San Francisco Park Reading](Misc/Images/san-francisco-park-reading.jpg)
...
* [sfo_neighborhoods_census_data.csv](main/Data/sfo_neighborhoods_census_data.csv)
* [neighborhoods_coordinates.csv](main/Data/neighborhoods_coordinates.csv)
* [Rental Analysis Starter Jupyter Notebook](main/rental_analysis.ipynb)
* [Dashboard Starter Jupyter Notebook](main/dashboard.ipynb)
...
Default Bar Chart
  ...
  ![unscaled-bar.png](Misc/Images/unscaled-bar.png)

Bar Chart with y-axis limits adjusted

  ![scaled-bar.png](Misc/Images/scaled-bar.png)
...
2. Visualize the mean `gross_rent` and `sale_price_sqr_foot` for each year as two line charts.
  ...
  ![gross-rent.png](Misc/Images/gross-rent.png)

  ![average-sales.png](Misc/Images/average-sales.png)
...
**Hint:** It will be easier to create a new DataFrame from grouping the data and calculating the mean prices for each year and neighborhood.
  ...
  ![avg-price-neighborhood.png](Misc/Images/avg-price-neighborhood.png)
  
  ![gross-rent-neighborhood.png](Misc/Images/gross-rent-neighborhood.png)
...
In this section, you want to figure out which neighborhoods are the most expensive. You will need to calculate the mean sale price for each neighborhood and then sort the values to obtain the top 10 most expensive neighborhoods on average. Plot the results as a bar chart.
  ...
  ![top-10-expensive-neighborhoods.png](Misc/Images/top-10-expensive-neighborhoods.png)
...
![rent-versus-price](Misc/Images/rent-versus-price.png)
...
Remember that in order to create maps visualizations using Plotly Express, you will need to create an account at [mapbox](https://www.mapbox.com/) and [create an access token](https://docs.mapbox.com/help/how-mapbox-works/access-tokens/#creating-and-managing-access-tokens).
  ...
  ![neighborhood-map.png](Misc/Images/neighborhood-map.png)
...
1. Create a Parallel Coordinates Plot.
  ...
  ![parallel-coordinates.png](Misc/Images/parallel-coordinates.png)

2. Create a Parallel Categories Plot.

  ![parallel-categories.png](Misc/Images/parallel-categories.png)
...
3. Create a Sunburst plot to show the most expensive neighborhoods in San Francisco per year.
    ...
    **Hint:** You can learn more about sunburst charts in Plotly Express in [this link](https://plotly.com/python/sunburst-charts/).
    ...
    ![sunburst](Misc/Images/sunburst.png)
...
Sample Dashboard:
  ...
  ![dashboard-demo.gif](Misc/Images/dashboard-demo.gif)
